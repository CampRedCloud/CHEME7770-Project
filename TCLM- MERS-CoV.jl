...
plt1 = plot(sol,vars=(0,1), xaxis="time", yaxis = "log10 Uninfected cells ",label="MERS-CoV-2" )
...
#vs t (column 0 of sol)
plt2 = plot(sol,vars=(0,2), xaxis="time", yaxis = "log10 Infected cells",label="MERS-CoV-2" )
...
#vs t
plt3 = plot(sol,vars=(0,3), xaxis="time", yaxis = "log10 Viral loads",label="MERS-CoV-2")

...
plot(sol6,vars=(0,3),xaxis=("time (days)"),yaxis=("log10 Viral Loads"),label=["SARS-CoV-2 no inhbition  "])
plot!(sol1,vars=(0,3),label=["15% inhbition"])
plot!(sol2,vars=(0,3),label=["40% inhbition"])
plot!(sol3,vars=(0,3),label=["60% inhbition"])
plot!(sol4,vars=(0,3),label=["80% inhbition"])
plot!(sol5,vars=(0,3),label=["100% inhbition"])
